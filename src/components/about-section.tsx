...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="relative overflow-hidden bg-slate-50 md:px-12 px-4"
    >
      <motion.div
        ...
        className="container mx-auto grid items-center gap-10 px-4 md:py-16 py-6 md:grid-cols-2 md:py-24"
      >
        <div
        ...
        >
          <div className="flex justify-center">
            <div className="inline-block rounded-full border px-3 py-1 text-xs font-medium text-slate-600">
              About the Society
            </div>
          </div>
          ...
          <p className="mt-3 text-slate-600 md:text-lg">
            MLSA MIET is a student community that empowers peers to learn,
            build, and share. We conduct workshops, hackathons, cloud study
            jams, and speaker series focused on modern technology—spanning Web,
            AI/ML, Cloud, and Design.
          </p>
          <ul className="mt-5 grid gap-2 text-slate-700">
            <li className="inline-flex items-center gap-2">
              ...
              />{" "}
              Peer-led workshops and mentoring
            </li>
            <li className="inline-flex items-center gap-2">
              <span
                className="h-1.5 w-1.5 rounded-full"
